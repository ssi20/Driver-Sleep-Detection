    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <h2 class="h5" style=" text-transform:none;">Driver</h2>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled active"> 
              ...
              <li  class="@if(Route::is('d_home'))  active @endif"><a href="/home" class="scroll"> <i class="icon-home"></i>Home                             </a></li>
              {{-- <li id=pk class="@if(Route::is('profile'))  active @endif"><a href="#" class="scroll"> <i class="icon-form"></i>Profile                            </a></li> --}}
          
              <li  class="@if(Route::is('d_index')) active @endif"><a href="/session"> <i class="fa fa-bar-chart"></i>Session                          </a></li>                 
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><strong class="text-light" style=" text-transform:none;">SleepNdrive</strong></div></a></div>
